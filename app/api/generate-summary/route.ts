  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a legal documentation assistant specializing in police encounter records. Generate clear, factual, and legally relevant summaries that could be used in legal proceedings. Focus on objective facts and avoid speculation.'
        },
        {
          role: 'user',
          content: prompt
